...
<asp:Content ID="ContentAction" ContentPlaceHolderID="Actions" runat="server">
     ...
     <telerik:RadAjaxPanel ID="RadAjaxPanel2" runat="server" LoadingPanelID="RadAjaxLoadingPanel2">
      <asp:ImageButton ID="BtnEmail" runat="server" ImageUrl="../assets/media/icons/mail.png" Style="height: 35px; width: 34px; margin-left: 5px;" ToolTip="Email" OnClick="BtnEmail_Click" AlternateText="Email" />
      <asp:ImageButton ID="BtnAttachment" runat="server" ImageUrl="../assets/media/icons/attach.png" Style="height: 35px; width: 34px; margin-left: 5px;" ToolTip="Stamped Copy"
      OnClick="BtnAttachment_Click" AlternateText="Stamp Copy" />
      <asp:ImageButton ID="imgbtnAR" runat="server" ImageUrl="../assets/media/icons/ar_alt.png" Style="height: 35px; width: 34px; margin-left: 5px;" ToolTip="AR Collection" OnClick="btnAR_Click" AlternateText="AR Collection" />
      <asp:ImageButton ID="editlpo" runat="server" ImageUrl="../assets/media/icons/lpo_edit.png" Style="height: 35px; width: 34px; margin-left: 5px;" ToolTip="Modify Invoice Header" OnClick="editlpo_Click" AlternateText="Modify Invoice Header" />
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <telerik:AjaxSetting AjaxControlID="editlpo">
    <UpdatedControls>
    <telerik:AjaxUpdatedControl ControlID="currentLpoNumber" />
     </UpdatedControls>
    </telerik:AjaxSetting>
    </AjaxSettings>
        <AjaxSettings>
    ...
    <telerik:AjaxSetting AjaxControlID="updatelpo">
    <UpdatedControls>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="col-lg-12 row">
                        <div class="col-lg-6">
                            <label class="control-label col-lg-12">Current LPO </label><br />
                            <asp:Label ID="currentLpoNumber" runat="server"></asp:Label>
                            
                        </div>
                        <div class="col-lg-6">
                                <label class="control-label col-lg-12">New LPO Number </label><br />
                                <asp:TextBox ID="txtLPONo" runat="server" CssClass="form-control" Width="100%" Placeholder="Enter LPO Number"></asp:TextBox>
                ...
                <div class="modal-footer">
                    ...
                    <telerik:RadAjaxPanel ID="RadAjaxPanel4" runat="server" LoadingPanelID="RadAjaxLoadingPanel2">
                        <asp:LinkButton ID="updatelpo" runat="server" Text="Yes" OnClick="updatelpo_Click" CssClass="btn btn-sm fw-bold btn-primary" ValidationGroup="grn"/>
                    </telerik:RadAjaxPanel>
