...
namespace SalesForceAutomation.BO_Digits.en
{
    public partial class AddEditCusRoute : System.Web.UI.Page
    {
                ...
                else
                {
                    ...
                    else                                                                        //If we are editing there will be a value and the following code will be executed.
                    {
                        ...
                        if (lstDatas.Rows.Count > 0)
                        {
                            ...
                            InstDelivery, AttachmentsAR,IsAttachmentOrder,AttachmentInvoice,FreeSampleOrder,CouponPayMode, CurrentSecurityDeposit, EnableLPONumber,LPONumberMand;
        ...
        public void SaveData()
        {
            ...
            CouponPayMode, CurrentSecurityDeposit, EnableLPONumber,LPONumberMand;
            ...
            if (ResponseID.Equals("0") || ResponseID == 0)
            {
                ...
                string[] arr = {   cus,cusType,TCL , CDays,PT,
                    ...
                    AttachmentsAR,IsAttachmentOrder,AttachmentInvoice,FreeSampleOrder,CouponPayMode,CurrentSecurityDeposit,EnableLPONumber,LPONumberMand};
            ...
            else
            {
                ...
                string[] arr = { RouteID.ToString(), cus,cusType,TCL , CDays,PT,noOfInv,IsVAT, IsHold,selectiontype,radius,oncall,IsSO,IsInvoicing,IsI_Sales, IsI_GR, IsI_BR, IsI_FG,
                    ...
                    EnableDelPriceChange,ARPayMode,rcs_EnforceBuyBackfree,MustSell, InstDelivery,AttachmentsAR,IsAttachmentOrder,AttachmentInvoice,FreeSampleOrder,CouponPayMode,CurrentSecurityDeposit,EnableLPONumber,LPONumberMand};
