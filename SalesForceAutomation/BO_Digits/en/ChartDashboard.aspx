    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        ...
        <div id="kt_content_container" class="col-lg-12">
            <div class="row g-5 g-xl-8">
                ...
                <%--Route delivery tag--%>
                <div class="col-lg-12 row">
                    <asp:PlaceHolder ID="pnlsalesorder" runat="server" visible="false">
                    <div class="col-lg-6">
                    ...
                    <asp:PlaceHolder ID="pnlrotdelivery" runat="server" Visible="false" >
                    <div class="col-lg-6">
                    ...
                    <asp:PlaceHolder ID="pnloutstandinginvoice" runat="server" >
                    <div class="col-lg-6">
                    ...
                    <div class="card card-xl-stretch mb-5 mb-xl-8">
                        ...
                        <div class="card-header border-0 pt-5">
                            ...
                            <div class="card-toolbar">
                                <div class="w3-row">
                                    ...
                                    <a href="javascript:void(1)" onclick="openPerforming(event, 'Outlet');">
                                        <div class="w3-third tablinks w3-bottombar w3-hover-light-grey w3-padding" style="width: 120px;">Customer HO</div>
                                    </a>
                                </div>
                            </div>
                            <!--end::Toolbar-->
                        ...
                        <div class="card-body">
                            ...
                            <div id="Customer" class="w3-container shop" style="display: none">
                             ...
                             <div id="Outlet" class="w3-container shop" style="display: none">
                                 <canvas id="MostPerformingOutlet"></canvas>
