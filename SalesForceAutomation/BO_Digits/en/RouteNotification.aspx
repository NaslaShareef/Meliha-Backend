                                ...
                                <telerik:RadGrid RenderMode="Lightweight" runat="server" EnableLinqExpressions="false" AllowMultiRowSelection="false"
                                    ...
                                    <MasterTableView AutoGenerateColumns="False" FilterItemStyle-Font-Size="XX-Small" CanRetrieveAllData="false"
                                        ...
                                        <Columns>
                                            ...
                                            <telerik:GridBoundColumn DataField="rnt_Header" AllowFiltering="true" HeaderStyle-Width="250px"
                                                HeaderStyle-Font-Size="Smaller" HeaderText="Message" FilterControlWidth="100%"
                                                CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false"
                                                HeaderStyle-Font-Bold="true" UniqueName="rnt_Header">
                                            </telerik:GridBoundColumn>

                                            <telerik:GridBoundColumn DataField="rnt_Desc" AllowFiltering="true" HeaderStyle-Width="200px"
                                            ...
                                            <telerik:GridBoundColumn DataField="rnt_Mode" AllowFiltering="true" HeaderStyle-Width="200px"
                                        ...
                                        HeaderStyle-Font-Bold="true" UniqueName="usr_Name">
                                            ...
                                            <telerik:GridBoundColumn DataField="rnt_IsDetail" AllowFiltering="true" HeaderStyle-Width="80px"
                                                HeaderStyle-Font-Size="Smaller" HeaderText="IsDetail" FilterControlWidth="100%"
                                                CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false"
