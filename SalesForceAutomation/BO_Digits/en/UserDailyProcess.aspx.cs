...
namespace SalesForceAutomation.BO_Digits.en
{
    public partial class UserDailyProcess : System.Web.UI.Page
    {
        ...
        {
            ddlRotType.DataSource = ObjclsFrms.loadList("SelectRouteforRotTypeDashboards", "sp_KPI_Dashboard", UICommon.GetCurrentUserID().ToString());
        ...
        public void Route(string DposubAreaCondition)
        {
            ...
            if (ddlRotType.SelectedValue.ToString() == "")
            {
                TypeCondition = "";
            }
            else
