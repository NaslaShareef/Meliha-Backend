    ...
    public partial class ReportDownload : System.Web.UI.Page
    {
        ...
        protected void download_Click(object sender, EventArgs e)
        {
            ...
            else if (ViewState["mode"].ToString().Equals("16"))
            {
                lblMessage.Visible = false;
                lblMessage.Text = "";
                string fileName = "16-Focus-ReturnReport";
                string dataQuery = "GetFocusReturnReport";
                string reportName = "(16-Focus-Return Report)";
                string reportSubName = "";
                string rotID = Rot();
                string mainCondition = "";
                mainCondition = mainCond(rotID);
            ...
            else if (ViewState["mode"].ToString().Equals("17"))
            {
                lblMessage.Visible = false;
                lblMessage.Text = "";
                string fileName = "17-DailySummaryReport";
                string rotID = Rot();
                string mainCondition = "";
                mainCondition = mainCond(rotID);
        ...
        protected void FocusReturn_Click(object sender, EventArgs e)
        {
            ViewState["mode"] = "16";
            int rotcount = Int32.Parse(ddlRoute.CheckedItems.Count.ToString());
            string fromDateStr = DateTime.Parse(rdfromDate.SelectedDate.ToString()).ToString("yyyyMMdd");
